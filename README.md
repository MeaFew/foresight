...
Raw CSVs (train, stores, oil, holidays, transactions)
    |
    v
Preprocess â”€â”€> Date features, log-transform, external merges
    |
    v
Feature Eng â”€â”€> Lags, rolling mean/std, seasonal encoding, promo features
    |
    ...
    |
    v
Evaluate â”€â”€> MAE, RMSE, MAPE, sMAPE, residual analysis
    |
    v
Dashboard â”€â”€> Forecast comparison, error distribution, residual analysis
```
